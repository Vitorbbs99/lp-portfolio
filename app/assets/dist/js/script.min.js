...
(function () {
  ...
  if ($counters.length > 0) {
    $counters.each(function () {
      var $el = $(this);
      var countTo = parseInt($el.attr("data-count"), 10) || 0;
      $({
        countCur: 0
      }).animate({
        countCur: countTo
