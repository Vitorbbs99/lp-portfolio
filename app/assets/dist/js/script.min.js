...
$(function () {
  ...
  $(".carrossel-depoimentos").each(function () {
    ...
    // Opções gerais do slide
    var carouselOpts = (_carouselOpts = {
      type: "loop",
      perPage: cols.desktop,
      perMove: 1,
      speed: 600,
      gap: "20px",
      autoplay: true
    }, _defineProperty(_carouselOpts, "speed", 800), _defineProperty(_carouselOpts, "interval", 3000), _defineProperty(_carouselOpts, "arrows", true), _defineProperty(_carouselOpts, "pagination", true), _defineProperty(_carouselOpts, "breakpoints", {
      // Tablet
      1200: {
        perPage: cols.tablet
      },
...
$(function () {
  ...
  $(".carrossel-fotos").each(function () {
    ...
    var carouselOpts = (_carouselOpts = {
      ...
      speed: 600,
      autoplay: true
    }, _defineProperty(_carouselOpts, "speed", 800), _defineProperty(_carouselOpts, "interval", 3000), _defineProperty(_carouselOpts, "arrows", true), _defineProperty(_carouselOpts, "pagination", false), _defineProperty(_carouselOpts, "breakpoints", {
      // Tablet
      1200: {
        perPage: cols.tablet
      },
